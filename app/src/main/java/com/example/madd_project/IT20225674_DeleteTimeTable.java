...
public class IT20225674_DeleteTimeTable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_it20225674_update_time_table);


        Spinner mySpinner = (Spinner) findViewById(R.id.days);
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(IT20225674_DeleteTimeTable.this,
        ...
        ArrayAdapter<String> myAdapter2 = new ArrayAdapter<String>(IT20225674_DeleteTimeTable.this,
        ...
        timeButton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(
                        IT20225674_DeleteTimeTable.this,
        ...
        timeButton2.setOnClickListener(new View.OnClickListener() {
         ...
         findViewById(R.id.dt_button).setOnClickListener(new View.OnClickListener() {
             @Override
             public void onClick(View view) {
                 new AlertDialog.Builder(IT20225674_DeleteTimeTable.this)
